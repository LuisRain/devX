...
//public class DevxMetrics implements PublicMetrics {
//
//    @Autowired
...
//        DevxFilter.RECORD_MAP.forEach((key, value) -> {
//            long urlSum = 0;
...
//            metricList.add(new Metric<>("dew.response.tps." + key, BigDecimal.valueOf(validList.size() * 1.0 / devxConfig.getMetric().getPeriodSec()).setScale(2, BigDecimal.ROUND_HALF_UP)));
...
//        metricList.add(new Metric<>("dew.response.tps", BigDecimal.valueOf(totalList.size() * 1.0 / devxConfig.getMetric().getPeriodSec()).setScale(2, BigDecimal.ROUND_HALF_UP)));
//        return metricList;
//    }
//
//}
