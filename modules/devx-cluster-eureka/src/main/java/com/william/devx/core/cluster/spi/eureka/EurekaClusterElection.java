package com.william.devx.core.cluster.spi.eureka;

import com.netflix.appinfo.InstanceInfo;
import com.william.devx.common.$;
import com.william.devx.core.cluster.ClusterElection;
...
@Component
@ConditionalOnExpression("#{'${devx.cluster.election}'=='eureka'}")
public class EurekaClusterElection implements ClusterElection {

    private static boolean leader = false;

    @Value("${devx.cluster.election.config.election-period-sec:60}")
