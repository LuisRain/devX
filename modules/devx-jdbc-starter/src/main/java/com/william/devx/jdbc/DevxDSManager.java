...
import com.william.devx.jdbc.config.DevxMultiDSConfig;
import com.william.devx.jdbc.sharding.ShardingConfiguration;
...
@Component
@DevxLoadImmediately
public class DevxDSManager implements DSManager {

    private static final Pattern LINE_TO_CAMEL_REGEX = Pattern.compile("-[a-z]{1}");

    @Autowired
    private DevxMultiDSConfig dsConfig;
    ...
    private void init() throws SQLException {
        ...
        beanFactory = (DefaultListableBeanFactory) ((ConfigurableApplicationContext) Devx.applicationContext).getBeanFactory();
        ...
        // Register primary DS
        AbstractBeanDefinition dsBean = BeanDefinitionBuilder.rootBeanDefinition(DevxDS.class)
